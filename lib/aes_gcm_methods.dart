...
_runAesGcmEncryption() async {
  ...
  final String cipherIvPbkdf2FilePath =
      '${directory.path}/cipher_iv_pbkdf2_g.txt';
  ...
  final String decryptIvPbkdf2FilePath =
      '${directory.path}/decrypt_iv_pbkdf2_g.txt';
  ...
  _decryptAesGcmMemory(ciphertextOldLoad, key, nonce);
...
_encryptAesGcm(String sourceFilePath, String destinationFilePath,
...
// using random access file
_decryptAesGcm(String sourceFilePath, String destinationFilePath,
    Uint8List key, Uint8List nonce) async {
  final int bufferLength = 2048;
  File fileSourceRaf = File(sourceFilePath);
  File fileDestRaf = File(destinationFilePath);
...
Uint8List _encryptAesGcmMemory(
...
Uint8List _decryptAesGcmMemory(
